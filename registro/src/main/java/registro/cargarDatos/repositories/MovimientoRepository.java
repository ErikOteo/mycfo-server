...
public interface MovimientoRepository extends JpaRepository<Movimiento, Long>, JpaSpecificationExecutor<Movimiento> {
        ...
        List<Movimiento> findByOrganizacionIdAndFechaEmisionIn(Long organizacionId,
                        java.util.Set<LocalDateTime> fechas);

        // Buscar por organización y rango de fechas
        List<Movimiento> findByOrganizacionIdAndFechaEmisionBetween(Long organizacionId, LocalDateTime inicio,
                        LocalDateTime fin);

        List<Movimiento> findByOrganizacionIdAndFechaEmisionBetweenAndMoneda(Long organizacionId, LocalDateTime inicio,
                        LocalDateTime fin, TipoMoneda moneda);
        ...
        // Query optimizada para obtener movimientos con filtros (reemplaza findAll +
        // filtros en memoria)
        ...
        // Query optimizada para sumar montos por categoría (reemplaza findAll + groupBy
        // en memoria)
        ...
        Page<Movimiento> findByOrganizacionIdAndDocumentoComercialIsNullAndMoneda(Long organizacionId,
        ...
        long countByOrganizacionIdAndMoneda(Long organizacionId, TipoMoneda moneda);

        long countByOrganizacionIdAndDocumentoComercialIsNull(Long organizacionId);

        long countByOrganizacionIdAndDocumentoComercialIsNullAndMoneda(Long organizacionId, TipoMoneda moneda);

        long countByOrganizacionIdAndDocumentoComercialIsNotNull(Long organizacionId);

        long countByOrganizacionIdAndDocumentoComercialIsNotNullAndMoneda(Long organizacionId, TipoMoneda moneda);
}
