...
# CARGA DE AUDIO
# =========================================================
t_start_audio = time.perf_counter()
...
Analizá el AUDIO de una FACTURA (lectura humana, dictado o grabación)
y devolvé exclusivamente los datos que encuentres con esta estructura JSON. Tene en cuenta que puede haber texto extra en el audio o uso de sinonimos.:
...
- No inventar datos, pero si se admite interpretar
...
print(f"Carga de audio      : {t_end_audio - t_start_audio:.3f} s")
